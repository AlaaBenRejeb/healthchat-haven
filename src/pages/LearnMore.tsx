          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white p-8 rounded-xl border border-emerald-100 hover:shadow-xl transition-all duration-300">
              ...
              <blockquote className="italic text-slate-600">
                ...
                <footer className="mt-2 font-semibold not-italic">— Michael Lee, Practice Manager</footer>
              </blockquote>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl border border-emerald-100 hover:shadow-xl transition-all duration-300">
              ...
              <blockquote className="italic text-slate-600">
                ...
                <footer className="mt-2 font-semibold not-italic">— Dr. Ayesha Khan, Specialist</footer>
              </blockquote>
            </div>
          </div>
        </div>
